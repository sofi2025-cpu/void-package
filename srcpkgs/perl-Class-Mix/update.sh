...
TPL="srcpkgs/perl-Class-Mix/template"

echo "### Checking for helium-browser updates..."

LATEST_VERSION=$(curl -s https://api.metacpan.org/v1/release/Class-Mix | jq -r .version | sed 's/^v//')
...
URL_X86="https://cpan.metacpan.org/authors/id/Z/ZE/ZEFRAM/Class-Mix-${LATEST_VERSION}.tar.gz"
...
echo "### Done! perl-Class-Mix updated to $LATEST_VERSION"
