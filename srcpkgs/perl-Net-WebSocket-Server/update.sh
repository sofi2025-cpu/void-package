...
URL_X86="https://cpan.metacpan.org/authors/id/T/TO/TOPAZ/Net-WebSocket-Server-${LATEST_VERSION}.tar.gz"
...
echo "### Done! perl-Net-WebSocket-Server updated to $LATEST_VERSION"
