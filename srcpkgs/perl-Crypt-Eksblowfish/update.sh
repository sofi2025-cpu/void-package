...
URL_X86="https://cpan.metacpan.org/authors/id/Z/ZE/ZEFRAM/Crypt-Eksblowfish-${LATEST_VERSION}.tar.gz"
...
echo "### Done! perl-Crypt-Eksblowfish updated to $LATEST_VERSION"
