...
URL_X86="https://cpan.metacpan.org/authors/id/C/CO/COOK/Device-SerialPort-${LATEST_VERSION}.tar.gz"
...
echo "### Done! perl-Device-SerialPort updated to $LATEST_VERSION"
