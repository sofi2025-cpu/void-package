...
URL_X86="https://cpan.metacpan.org/authors/id/F/FE/FERREIRA/Number-Bytes-Human-${LATEST_VERSION}.tar.gz"
...
echo "### Done! perl-Number-Bytes-Human updated to $LATEST_VERSION"
